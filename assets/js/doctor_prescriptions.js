let allMedicines = [];
let loggedInUser = document.body.dataset.staffId;
console.log('Staff ID from data attribute:', loggedInUser);
            ...
            fetch('../../app/controller/DoctorController.php', {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        addMedicineRow();
                        loadPrescriptions();
                        loadDoctorStats(); // Refresh stats after creating prescription
                    } else {
