<!-- pharmacist dispense history -->
<div class="tab-content" id="dispense-history">
    <!-- stat counters -->
    <br>
    <div class="stats-container mb-4">
        <div class="stat-card">
            ...
            <div class="stat-value" id="totalDispensed">0</div>
        </div>
        <div class="stat-card">
            <div class="stat-icon"><i class="bi bi-calendar-day"></i></div>
            <p class="stat-label">Today</p>
            <div class="stat-value" id="dispensedToday">0</div>
        </div>
        <div class="stat-card">
            <div class="stat-icon"><i class="bi bi-calendar-week"></i></div>
            <p class="stat-label">This Week</p>
            <div class="stat-value" id="dispensedThisWeek">0</div>
        </div>
        <div class="stat-card">
            <div class="stat-icon"><i class="bi bi-calendar-month"></i></div>
            <p class="stat-label">This Month</p>
            <div class="stat-value" id="dispensedThisMonth">0</div>
        </div>
    </div>
